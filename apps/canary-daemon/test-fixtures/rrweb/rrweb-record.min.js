var rrwebRecord = (function () {
    ...
    for (var r = 50, n = 0; n < e.width; n += r)
      for (var o = 0; o < e.height; o += r) {
        var s = t.getImageData,
          l = Ve in s ? s[Ve] : s,
          a = new Uint32Array(
            l.call(t, n, o, Math.min(r, e.width - n), Math.min(r, e.height - o)).data.buffer
          );
        if (
          a.some(function (i) {
            return i !== 0;
  ...
  function er(e, t) {
    ...
    return (
      d && (i = "SCRIPT_PLACEHOLDER"),
      !c && !d && i && He(e, n, o) && (i = s ? s(i) : i.replace(/[\S]/g, "*")),
      { type: x.Text, textContent: i || "", isStyle: c, rootId: l }
    );
  }
  function tr(e, t) {
    for (
    ...
    if (y === "input" || y === "textarea" || y === "select") {
      var X = e.value,
        Z = e.checked;
      f.type !== "radio" && f.type !== "checkbox" && f.type !== "submit" && f.type !== "button" && X
        ? (f.value = xe({
            type: f.type,
            tagName: y,
            value: X,
    ...
    if (
      (y === "option" && (e.selected && !a.select ? (f.selected = !0) : delete f.selected),
      y === "canvas" && h)
    ) {
    ...
    if (y === "img" && u) {
      ...
      var Q = function () {
        try {
          ((ie.width = N.naturalWidth),
            (ie.height = N.naturalHeight),
            je.drawImage(N, 0, 0),
            (f.rr_dataURL = ie.toDataURL(d.type, d.quality)));
        } catch (U) {
    ...
    if (
      ((y === "audio" || y === "video") &&
        ((f.rr_mediaState = e.paused ? "paused" : "played"),
    ...
    return (
      y === "iframe" && !m(f.src) && (e.contentDocument || (f.rr_src = f.src), delete f.src),
      {
        type: x.Element,
        tagName: y,
        attributes: f,
        ...
        ((t.script &&
          ...
          (e.tagName === "meta" &&
            ((t.headMetaDescKeywords && M(e.attributes.name).match(/^description|keywords$/)) ||
              (t.headMetaSocial &&
                (M(e.attributes.property).match(/^(og|twitter|fb):/) ||
                  M(e.attributes.name).match(/^(og|twitter):/) ||
                  M(e.attributes.name) === "pinterest")) ||
              (t.headMetaRobots &&
                (M(e.attributes.name) === "robots" ||
                  M(e.attributes.name) === "googlebot" ||
                  M(e.attributes.name) === "bingbot")) ||
    ...
    n.hasNode(e)
      ...
      : rr(U, g) ||
          (!z &&
            U.type === x.Text &&
            !U.isStyle &&
            !U.textContent.replace(/^\s+|\s+$/gm, "").length)
        ? (ae = ge)
        : (ae = Ze());
...
or you can use record.mirror to access the mirror instance during recording.`;
    ...
    try {
      ...
      return (
        typeof o == "function" &&
          ...
          Object.defineProperties(o, { __rrweb_original__: { enumerable: !1, value: n } })),
        (e[t] = o),
        () => {
          e[t] = n;
        }
  ...
  class lr {
    ...
    removeNode(t) {
      ...
      !this.head ||
        (r.previous
          ? ((r.previous.next = r.next), r.next && (r.next.previous = r.previous))
        ...
        (this.emit = () => {
          ...
          const t = [],
            ...
            o = (a) => {
              var i, c, d, u;
              let h = null;
              ((c = (i = a.getRootNode) == null ? void 0 : i.call(a)) == null
                ? void 0
                : c.nodeType) === Node.DOCUMENT_FRAGMENT_NODE &&
                a.getRootNode().host &&
                (h = a.getRootNode().host);
              let m = h;
              for (
                ;
                ((u = (d = m?.getRootNode) == null ? void 0 : d.call(m)) == null
                  ? void 0
                  : u.nodeType) === Node.DOCUMENT_FRAGMENT_NODE && m.getRootNode().host;
              )
              ...
              const S = le(a, {
                ...
                onSerialize: (y) => {
                  (Je(y, this.mirror) && this.iframeManager.addIframe(y),
                    Qe(y, this.mirror) && this.stylesheetManager.trackLinkElement(y),
                    qe(a) && this.shadowDomManager.addShadowRoot(a.shadowRoot, this.doc));
                },
                onIframeLoad: (y, f) => {
          ...
          for (const a of Array.from(this.movedSet.values()))
            (rt(this.removes, a, this.mirror) && !this.movedSet.has(a.parentNode)) || o(a);
          for (const a of Array.from(this.addedSet.values()))
            (!ot(this.droppedSet, a) && !rt(this.removes, a, this.mirror)) || ot(this.movedSet, a)
              ? o(a)
            ...
            switch (t.type) {
              case "characterData": {
                ...
                !_(t.target, this.blockClass, this.blockSelector, !1) &&
                  ...
                  this.texts.push({
                    value:
                      He(t.target, this.maskTextClass, this.maskTextSelector) && r
                        ? this.maskTextFn
                          ? this.maskTextFn(r)
                          : r.replace(/[\S]/g, "*")
                        : r,
              ...
              case "attributes": {
                ...
                if (
                  (o || ((o = { node: t.target, attributes: {} }), this.attributes.push(o)),
                  t.attributeName === "style")
                ) {
                  const s = this.doc.createElement("span");
                  (t.oldValue && s.setAttribute("style", t.oldValue),
                    (o.attributes.style === void 0 || o.attributes.style === null) &&
                      (o.attributes.style = {}));
                  ...
                  for (const a of Array.from(r.style)) {
                    ...
                    (i !== s.style.getPropertyValue(a) || c !== s.style.getPropertyPriority(a)) &&
                      (c === "" ? (l[a] = i) : (l[a] = [i, c]));
                  }
                    ...
                    _(t.target, this.blockClass, this.blockSelector, !1) ||
                      ...
                      (this.addedSet.has(r)
                        ...
                        : (this.addedSet.has(t.target) && n === -1) ||
                          ...
                          (this.movedSet.has(r) && this.movedMap[tt(n, o)]
                            ? _e(this.movedSet, r)
                            : this.removes.push({
                                parentId: o,
                                id: n,
        ...
        (this.genAdds = (t, r) => {
          if (this.mirror.hasNode(t)) {
            ...
            (r && this.mirror.hasNode(r) && (n = this.mirror.getId(r)),
              n && n !== -1 && (this.movedMap[tt(this.mirror.getId(t), n)] = !0));
          } else (this.addedSet.add(t), this.droppedSet.delete(t));
          _(t, this.blockClass, this.blockSelector, !1) ||
  ...
  var dr = Object.defineProperty,
    ...
    it = (e, t, r) =>
      t in e ? dr(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r),
    lt = (e, t) => {
    ...
    const i = Se((u) => {
      ...
      c = Se(
        (u) => {
          ...
          (a || (a = Date.now()),
            l.push({ x: m, y: p, id: n.getId(h), timeOffset: Date.now() - a }),
            i(
  ...
  function br({
    ...
    function d(g) {
      ...
      const y = g.isTrusted;
      if (
        (S && S.tagName === "OPTION" && (S = S.parentElement),
        !S || !S.tagName || vr.indexOf(S.tagName) < 0 || _(S, n, o, !0))
      )
        return;
      const f = S.type;
      ...
      (f === "radio" || f === "checkbox"
        ? (F = S.checked)
        : (l[S.tagName.toLowerCase()] || l[f]) &&
          (w = xe({ maskInputOptions: l, tagName: S.tagName, type: f, value: w, maskInputFn: a })),
  ...
  function Oe(e) {
    ...
    function r(n, o) {
      if (
        (ct && n.parentRule instanceof CSSGroupingRule) ||
        (dt && n.parentRule instanceof CSSMediaRule) ||
        (ut && n.parentRule instanceof CSSSupportsRule) ||
  ...
  function oe(e, t, r) {
    let n, o;
    return e
      ? (e.ownerNode ? (n = t.getId(e.ownerNode)) : (o = r.getId(e)), { styleId: o, id: n })
      : {};
  }
  function Ir({ styleSheetRuleCb: e, mirror: t, stylesheetManager: r }, { win: n }) {
    ...
    n.CSSStyleSheet.prototype.insertRule = function (d, u) {
      ...
      return (
        ((h && h !== -1) || (m && m !== -1)) &&
          e({ id: h, styleId: m, adds: [{ rule: d, index: u }] }),
        o.apply(this, [d, u])
      );
    };
    ...
    n.CSSStyleSheet.prototype.deleteRule = function (d) {
      ...
      return (
        ((u && u !== -1) || (h && h !== -1)) && e({ id: u, styleId: h, removes: [{ index: d }] }),
        s.apply(this, [d])
      );
    };
    let l;
    n.CSSStyleSheet.prototype.replace &&
      ...
      (n.CSSStyleSheet.prototype.replace = function (d) {
        const { id: u, styleId: h } = oe(this, t, r.styleMirror);
        return (
          ((u && u !== -1) || (h && h !== -1)) && e({ id: u, styleId: h, replace: d }),
          l.apply(this, [d])
        );
      }));
    let a;
    n.CSSStyleSheet.prototype.replaceSync &&
      ...
      (n.CSSStyleSheet.prototype.replaceSync = function (d) {
        const { id: u, styleId: h } = oe(this, t, r.styleMirror);
        return (
          ((u && u !== -1) || (h && h !== -1)) && e({ id: u, styleId: h, replaceSync: d }),
          a.apply(this, [d])
        );
      }));
    const i = {};
    ct
      ...
      : (dt && (i.CSSMediaRule = n.CSSMediaRule),
        pt && (i.CSSConditionRule = n.CSSConditionRule),
        ut && (i.CSSSupportsRule = n.CSSSupportsRule));
    const c = {};
    return (
      Object.entries(i).forEach(([d, u]) => {
        ((c[d] = { insertRule: u.prototype.insertRule, deleteRule: u.prototype.deleteRule }),
          (u.prototype.insertRule = function (h, m) {
            ...
            return (
              ((p && p !== -1) || (v && v !== -1)) &&
                e({ id: p, styleId: v, adds: [{ rule: h, index: [...Oe(this), m || 0] }] }),
              c[d].insertRule.apply(this, [h, m])
            );
          }),
          (u.prototype.deleteRule = function (h) {
            ...
            return (
              ((m && m !== -1) || (p && p !== -1)) &&
                e({ id: m, styleId: p, removes: [{ index: [...Oe(this), h] }] }),
              c[d].deleteRule.apply(this, [h])
            );
          }));
      }),
      () => {
    ...
    const a =
        r.nodeName === "#document"
          ? (n = r.defaultView) == null
            ? void 0
            : n.Document
          : (s = (o = r.ownerDocument) == null ? void 0 : o.defaultView) == null
            ? void 0
            : s.ShadowRoot,
  ...
  function Cr(
    ...
    o.CSSStyleDeclaration.prototype.setProperty = function (a, i, c) {
      ...
      const { id: u, styleId: h } = oe(
        (d = this.parentRule) == null ? void 0 : d.parentStyleSheet,
        t,
        n.styleMirror
      );
      return (
        ((u && u !== -1) || (h && h !== -1)) &&
          e({
            id: u,
            styleId: h,
            set: { property: a, value: i, priority: c },
            index: Oe(this.parentRule),
          }),
        s.apply(this, [a, i, c])
      );
    };
    ...
    return (
      (o.CSSStyleDeclaration.prototype.removeProperty = function (a) {
        ...
        const { id: c, styleId: d } = oe(
          (i = this.parentRule) == null ? void 0 : i.parentStyleSheet,
          t,
          n.styleMirror
        );
        return (
          ((c && c !== -1) || (d && d !== -1)) &&
            e({ id: c, styleId: d, remove: { property: a }, index: Oe(this.parentRule) }),
          l.apply(this, [a])
        );
      }),
      () => {
  ...
  function kr({ mediaInteractionCb: e, blockClass: t, blockSelector: r, mirror: n, sampling: o }) {
    const s = (a) =>
      ...
      l = [
        A("play", s(pe.Play)),
        A("pause", s(pe.Pause)),
        A("seeked", s(pe.Seeked)),
        A("volumechange", s(pe.VolumeChange)),
        A("ratechange", s(pe.RateChange)),
      ];
    return () => {
      l.forEach((a) => a());
    };
  ...
  function Mr({ fontCb: e, doc: t }) {
    ...
    r.FontFace = function (a, i, c) {
      ...
      return (
        o.set(d, {
          family: a,
          buffer: typeof i != "string",
          descriptors: c,
          fontSource: typeof i == "string" ? i : JSON.stringify(Array.from(new Uint8Array(i))),
        }),
        d
      );
    };
  ...
  function wr(e) {
    ...
    const a = () => {
      ...
      for (let u = 0; u < d; u++) {
        ...
        _(m, n, o, !0) ||
          _(v, n, o, !0) ||
          c.push({ start: r.getId(m), startOffset: p, end: r.getId(v), endOffset: g });
      }
      s({ ranges: c });
    };
  ...
  class Rr {
    constructor(t) {
      ((this.iframes = new WeakMap()),
        ...
        (this.crossOriginIframeStyleMirror = new St(
    ...
    transformCrossOriginEvent(t, r) {
      ...
      switch (r.type) {
        case C.FullSnapshot:
          return (
            ...
            this.replaceIdOnNode(r.data.node, t),
            {
              ...
              data: {
                source: I.Mutation,
                adds: [{ parentId: this.mirror.getId(t), nextId: null, node: r.data.node }],
                removes: [],
                texts: [],
                attributes: [],
                isAttachIframe: !0,
        ...
        case C.Custom:
          return (
            this.replaceIds(r.data.payload, t, ["id", "parentId", "previousId", "nextId"]),
            r
          );
    ...
    replace(t, r, n, o) {
      for (const s of o)
        (!Array.isArray(r[s]) && typeof r[s] != "number") ||
          (Array.isArray(r[s]) ? (r[s] = t.getIds(n, r[s])) : (r[s] = t.getId(n, r[s])));
      return r;
    }
    replaceIds(t, r, n) {
  ...
  var Er = Object.defineProperty,
    ...
    bt = (e, t, r) =>
      t in e ? Er(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r),
    It = (e, t) => {
  ...
  class Fr {
    ...
    addShadowRoot(t, r) {
      !ye(t) ||
        ...
        mt(
          Ct(It({}, this.bypassOptions), { scrollCb: this.scrollCb, doc: t, mirror: this.mirror })
        ),
        setTimeout(() => {
  ...
  for (
    var he = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
      Ar = typeof Uint8Array > "u" ? [] : new Uint8Array(256),
      Te = 0;
    Te < he.length;
    Te++
  )
    Ar[he.charCodeAt(Te)] = Te;
  var _r = function (e) {
    ...
    for (r = 0; r < n; r += 3)
      ((o += he[t[r] >> 2]),
        (o += he[((t[r] & 3) << 4) | (t[r + 1] >> 4)]),
        (o += he[((t[r + 1] & 15) << 2) | (t[r + 2] >> 6)]),
        (o += he[t[r + 2] & 63]));
    return (
      n % 3 === 2
    ...
    if (e instanceof ArrayBuffer) {
      ...
      if (e instanceof DataView)
        return {
          ...
          args: [Re(e.buffer, t, r), e.byteOffset, e.byteLength],
        };
      if (e instanceof HTMLImageElement) {
        ...
        if (e instanceof ImageData)
          return { rr_type: e.constructor.name, args: [Re(e.data, t, r), e.width, e.height] };
  ...
  function Tt(e, t, r) {
    ...
    try {
      const o = de(e.HTMLCanvasElement.prototype, "getContext", function (s) {
        return function (l, ...a) {
          return (
            _(this, t, r, !0) || "__context" in this || (this.__context = l),
            s.apply(this, [l, ...a])
          );
        };
      });
  ...
  function zr(e, t, r, n, o) {
    ...
    return (
      ...
      typeof t.WebGL2RenderingContext < "u" &&
        s.push(...Rt(t.WebGL2RenderingContext.prototype, ue.WebGL2, e, r, n, o, t)),
      () => {
        s.forEach((l) => l());
      }
    );
  ...
  function Gr(e, t) {
    var r = atob(e);
    if (t) {
      for (var n = new Uint8Array(r.length), o = 0, s = r.length; o < s; ++o)
        n[o] = r.charCodeAt(o);
...
`,
  ...
  class Yr {
    constructor(t) {
      ...
      ((this.mutationCb = t.mutationCb),
        (this.mirror = t.mirror),
        l && r === "all" && this.initCanvasMutationObserver(n, o, s),
        l && typeof r == "number" && this.initCanvasFPSObserver(r, n, o, s, { dataURLOptions: a }));
    }
    reset() {
              ...
              args: [
                {
                  rr_type: "ImageBitmap",
                  args: [
                    { rr_type: "Blob", data: [{ rr_type: "ArrayBuffer", base64: g }], type: S },
                  ],
                },
                0,
                0,
            ...
            h().forEach((v) =>
              Br(this, null, function* () {
                ...
                if ((a.set(S, !0), ["webgl", "webgl2"].includes(v.__context))) {
                  ...
                  ((g = f?.getContextAttributes()) == null ? void 0 : g.preserveDrawingBuffer) ===
                    !1 && f?.clear(f.COLOR_BUFFER_BIT);
                }
  ...
  var Kr = Object.defineProperty,
    ...
    Nt = (e, t, r) =>
      t in e ? Kr(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r),
    V = (e, t) => {
  ...
  function be(e = {}) {
    ...
    T = (b, G) => {
      var K;
      if (
        (((K = se[0]) == null ? void 0 : K.isFrozen()) &&
          b.type !== C.FullSnapshot &&
          !(b.type === C.IncrementalSnapshot && b.data.source === I.Mutation) &&
          se.forEach((R) => R.unfreeze()),
        Y)
      )
        t?.(ne(b), G);
      else if ($) {
    ...
    Ee = (b = !1) => {
      var G, K, R, ee, k, H;
      (T(L({ type: C.Meta, data: { href: window.location.href, width: Ye(), height: Be() } }), b),
        q.reset(),
        se.forEach((W) => W.lock()));
      const Ie = nr(document, {
        ...
        inlineImages: O,
        onSerialize: (W) => {
          (Je(W, J) && re.addIframe(W),
            Qe(W, J) && q.trackLinkElement(W),
            qe(W) && me.addShadowRoot(W.shadowRoot, document));
        },
        onIframeLoad: (W, We) => {
      ...
      (T(
              ...
              left:
                window.pageXOffset !== void 0
                  ...
                  : document?.documentElement.scrollLeft ||
                    ((K = (G = document?.body) == null ? void 0 : G.parentElement) == null
                      ? void 0
                      : K.scrollLeft) ||
                    ((R = document?.body) == null ? void 0 : R.scrollLeft) ||
                    0,
              top:
                window.pageYOffset !== void 0
                  ? window.pageYOffset
                  : document?.documentElement.scrollTop ||
                    ((k = (ee = document?.body) == null ? void 0 : ee.parentElement) == null
                      ? void 0
                      : k.scrollTop) ||
                    ((H = document?.body) == null ? void 0 : H.scrollTop) ||
                    0,
            },
          },
        })
        ...
        document.adoptedStyleSheets &&
          ...
          q.adoptStyleSheets(document.adoptedStyleSheets, J.getId(document)));
    };
    try {
      const b = [];
      b.push(
        ...
        return Tr(
          {
            mutationCb: z,
            mousemoveCb: (k, H) =>
              T(L({ type: C.IncrementalSnapshot, data: { source: H, positions: k } })),
            mouseInteractionCb: (k) =>
              T(L({ type: C.IncrementalSnapshot, data: V({ source: I.MouseInteraction }, k) })),
            scrollCb: U,
            viewportResizeCb: (k) =>
              T(L({ type: C.IncrementalSnapshot, data: V({ source: I.ViewportResize }, k) })),
            inputCb: (k) => T(L({ type: C.IncrementalSnapshot, data: V({ source: I.Input }, k) })),
            mediaInteractionCb: (k) =>
              T(L({ type: C.IncrementalSnapshot, data: V({ source: I.MediaInteraction }, k) })),
            styleSheetRuleCb: (k) =>
              T(L({ type: C.IncrementalSnapshot, data: V({ source: I.StyleSheetRule }, k) })),
            styleDeclarationCb: (k) =>
              T(L({ type: C.IncrementalSnapshot, data: V({ source: I.StyleDeclaration }, k) })),
            canvasMutationCb: ae,
            ...
            plugins:
              ((ee = X?.filter((k) => k.observer)) == null
                ? void 0
                : ee.map((k) => ({
                    observer: k.observer,
                    options: k.options,
                    callback: (H) => T(L({ type: C.Plugin, data: { plugin: k.name, payload: H } })),
                  }))) || [],
          },
          v
        );
